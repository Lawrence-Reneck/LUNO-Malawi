<div id="featured">
			<div class="container">
				<div class="row">
			@foreach($artists_legend as $legend_artist )
					</section>
					<section class="4u">
						<div class="box">
							<!-- <a href="#" class="image left"><img src="/images/pics05.jpg" alt=""></a> -->
							<a href="#" class="image left"><img src="{{ ('/storage/imagesORartworks/'.$legend_artist->profile_picture) }}" alt=""></a>
							<h3>{{$legend_artist->stage_name}}</h3>
							<p>{{ substr($legend_artist->biography, 0, 70) }}.</p>
							<a href="show_artist/{{$legend_artist->id}}" class="button">view legend</a>
						</div>
					</section>
				@endforeach
				</div>
				...
				<div class="row">
					<div class="3u">
						<section>
							...
							<div class="balloon">
								<blockquote>&ldquo;&nbsp;&nbsp;  {{$quote->quote}}  &nbsp;&nbsp;&rdquo;<br>
									<br>
									<strong>&ndash;&nbsp;&nbsp;{{$quote->owner}}  </strong></blockquote>
							</div>
							@endforeach
