          ...
          <div class=" card-body col-lg-10 col-md-10 col-sm-8 ml-auto mr-auto" style="margin: auto; border: 2px solid black; padding: 10px">
            ...
            <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="name" name="residence" id="edit_artist_residence" class="form-control" placeholder="{{ __('Lusaka/Zambia or Lilongwe/Malawi') }}" required>
              </div>
          ...
          <div class=" card-body col-lg-10 col-md-10 col-sm-8 ml-auto mr-auto" style="margin: auto; border: 2px solid black; padding: 10px">
            ...
            <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="name" name="residence" id="residence" class="form-control" placeholder="{{ __('Lusaka/Zambia or Lilongwe/Malawi') }}" required>
              </div>
              @if ($errors->has('residence'))
                <div id="residence-error" class="error text-danger pl-3" for="residence" style="display: block;">
                  <strong>{{ $errors->first('residence') }}</strong>
