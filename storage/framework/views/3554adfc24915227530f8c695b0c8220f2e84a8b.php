  ...
  <div class="col-lg-8 col-md-8 col-sm-8 ml-auto justify-content-center"  style="margin: auto; width: 60%; border: 2px solid black; padding: 10px">
   <form method="POST" action=""   enctype="multipart/form-data" id="quote-form">
        ...
        <section style="margin: auto; width: 80%; border: 2px solid black; padding: 10px">
          ...
          <div id="quote_row">
            <header>
              ...
              <button type="button" class="btn btn-warning btn-ed" id="edit_<?php echo e($quote->id); ?>">edit </button>
          ...
          <form method="POST" action="<?php echo e(url('/create_breaking_news')); ?>" enctype="multipart/form-data">
            ...
            <br>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">
                      <i class="material-icons">beaking news source</i>
                  </span>
                </div>
        ...
        <div class="container col-md-10" style="background:grey"> 
              ...
              <p>
                <h3><?php echo e($news->title); ?> <a href="/delete_news/<?php echo e($news->id); ?>" class="btn btn-danger">delete</a> <a href="/edit_news/<?php echo e($news->id); ?>" class="btn btn-warning">edit</a></h3>
              ...
              <tr>
                ...
                <tbody>
                  ...
                  <tr>									
                    ...
                    <td style='color:#000;'><?php echo e($song_mp3->stage_name); ?></h4></td>
...
<?php /**PATH C:\xampp\htdocs\luno\resources\views/admin_dashboard.blade.php ENDPATH**/ ?>