        ...
        <?php echo method_field('PUT'); ?>
          <div class="input-group">
            ...
            <br>
              ...
              <textarea name="quote" id="edit-quote-quote" cols="30" rows="1" class="form-control" value="<?php echo e(old('quote     ')); ?>" required></textarea>
            </div>
...
<form method="POST" action=""   enctype="multipart/form-data" id="quote-form">
            ...
            <br>
              ...
              <textarea name="quote" id="quote_id" cols="30" rows="1" class="form-control" value="<?php echo e(old('quote     ')); ?>" required></textarea>
            </div>
...
<?php /**PATH C:\xampp\htdocs\luno\resources\views/pages/quote.blade.php ENDPATH**/ ?>